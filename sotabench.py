...
model_configs.append(
    {'model_name': 'CRPN Fast R-CNN (ResNet-50-FPN)', 
     ...
     'weights_url': 'https://github.com/deepparrot/Cascade-RPN/releases/download/0.1/crpn_fast_rcnn_r50_fpn_1x_20191008-9e7696ae.pth',
     'weights_name': 'crpn_fast_rcnn_r50_fpn_1x_20191008-9e7696ae.pth',
...
model_configs.append(
    {'model_name': 'CRPN Faster R-CNN (ResNet-50-FPN)', 
     'paper_arxiv_id': '1909.06720',
     'weights_url': 'https://github.com/deepparrot/Cascade-RPN/releases/download/0.1/crpn_faster_rcnn_fpn_1x_20191008-cb1e5335.pth',
     'weights_name': 'crpn_faster_rcnn_fpn_1x_20191008-cb1e5335.pth',
     'config': './configs/cascade_rpn/crpn_faster_rcnn_r50_fpn_1x.py',
    'paper_results': None}
)
